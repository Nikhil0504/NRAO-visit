...
def runAutoCleanCube(vn=['v1.ms','v2.ms'],specwindow='', lineID=0, grid='standard',fieldname = '', sourcename = '', synbeam=0.3,imsize_pix=256,weightscheme='briggs',robustfactor = 2.0, tag='taginfo',outfolder = 'root/sourcename/weightinginfo/',startendvel=[-2000,2000],velres=50.0, thresh='3.0mJy',deletefiles=True):        
        ...
        if CubeInput:
                ...
                imsize = imsize_pix
                #phasecenter = 'ICRS 08:46:49.317 15:05:58.746'
                #psfphasecenter='ICRS 08:46:49.317 15:05:58.746'

                phasecenter = 'ICRS 131.7054875deg 15.0996517deg'
                psfphasecenter='ICRS 131.7054875deg 15.0996517deg'
        ...
        if DOLINEIMAGING:
                tclean(vis=vn,
                        ...
                        calcres=True, calcpsf=True, parallel=True  # These save some time to avoid recalculating saved products
                        )
